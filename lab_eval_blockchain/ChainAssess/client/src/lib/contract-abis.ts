...
export const CONTRACT_ADDRESSES = {
  ...
  TOKEN_REWARD: import.meta.env.VITE_TOKEN_REWARD_CONTRACT || '0x9151B358942B3278bEbC7359f75C4110CA5ebc55'
};

// Demo contract addresses for testing (Sepolia testnet) - VALID CHECKSUM ADDRESSES
export const DEMO_CONTRACT_ADDRESSES = {
  ACCESS_CONTROL: '0xFB7c09E0d25577401cB98C9b29B0465243A97E5F',
  BATCH_MANAGEMENT: '0xddD637Fd04a8b14470Bcf3b78c683c1a87C99aB8',
  ASSIGNMENT_SUBMISSION: '0xf39A62a69222ad7F51217AFedd46178e7926039d',
  TOKEN_REWARD: '0x9151B358942B3278bEbC7359f75C4110CA5ebc55'
};